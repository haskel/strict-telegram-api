...
class MessageApi
{
    ...
    public function sendMessage(
        ...
        do {
            ...
            $responses[]  = $this->caller->call(HappyCustomerBot::NAME, 'sendMessage', $request);
...
//        return end($responses);
    ...
    )
    {
        ...
        return $this->caller->call(HappyCustomerBot::NAME, 'editMessageText', $request);
    }
    ...
    )
    {
        ...
        return $this->caller->call(HappyCustomerBot::NAME, 'editMessageCaption', $request);
    }
    ...
    )
    {
        ...
        return $this->caller->call(HappyCustomerBot::NAME, 'editMessageMedia', $request);
    }
    ...
    )
    {
        ...
        return $this->caller->call(HappyCustomerBot::NAME, 'editMessageReplyMarkup', $request);
    }
    ...
    )
    {
        ...
        return $this->caller->call(HappyCustomerBot::NAME, 'stopPoll', $request);
    }
    ...
    )
    {
        ...
        return $this->caller->call(HappyCustomerBot::NAME, 'deleteMessage', $request);
    }
}
